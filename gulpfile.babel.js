...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-programmer-error.js",
      format: "umd",
      name: "capnpJsProgrammerError",
      sourcemap: true,
      globals: {
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-programmer-error.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-programmer-error.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-programmer-error.js.map",
            },
          }))
